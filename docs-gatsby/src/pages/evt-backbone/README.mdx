...
=======
* [See also our own Kafka study article](../kafka/readme.mdx) on how to support high availability and how to deploy to your local environment or to a kubernetes cluster like IBM Cloud Private.
>>>>>>> fix broken links
...
=======
    * [Event Streams deployment](../deployments/eventstreams/README.mdx).
    * [Zookeeper deployment](../deployments/zookeeper/README.mdx) and [Kafka deployment](../deployments/kafka/README.mdx) for ICP.
>>>>>>> fix broken links
