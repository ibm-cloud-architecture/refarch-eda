...
=======
[Read more on patterns](../design-patterns/ED-patterns.mdx)

### Supporting products and suggested reading

* [Event backbone](https://github.com/ibm-cloud-architecture/refarch-eda/blob/master/docs/evt-backbone/README.mdx)
>>>>>>> fix broken links
=======
[Read more on patterns](../design-patterns/ED-patterns/)
...
* [Event backbone](https://github.com/ibm-cloud-architecture/refarch-eda/blob/master/docs/evt-backbone/README/)
>>>>>>> fixed broken links
