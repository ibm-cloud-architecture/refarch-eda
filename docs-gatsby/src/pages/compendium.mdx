...
* [Kafka summary and deployment on IBM Cloud Private](./kafka/readme/)
...
* [Our skill journey](training/eda-skill-journey/) but it is under work to migrate to IBM learning journey.
...
* [Service mesh](https://github.com/ibm-cloud-architecture/refarch-integration/blob/master/docs/service-mesh/readme/)
