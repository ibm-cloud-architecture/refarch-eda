...
```src/test/java/com/ibm/garage/cpat/TestLoadKtableFromTopic.java```
You can customize this file path post `src/test/java/.../TestLoadKtableFromTopic.java` to however you see fit.
...
`src/main/java/com/ibm/garage/cpat/Domain/FinancialMessage.java`
...
for separation of logic. `src/test/java/com/ibm/garage/cpat/lab/TestFinancialMessage.java`. Again you may use your own
