...
* Deploy a simple Kafka cluster with the name `lab-kafka` (see the yaml file: `kafka-cluster.yaml`). 
...
* Get MQ connection characteristics, like service name and port number
