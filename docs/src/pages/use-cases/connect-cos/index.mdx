...
- We will need to create a single `INBOUND` topic. The `INBOUND` topic is where our Quarkus application will produce to and where our IBM COS Sink Connector will pull data from to send to the COS Bucket.
