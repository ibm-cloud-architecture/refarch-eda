...
The  [product documentation](https://debezium.io/documentation/reference/connectors/db2.html) presents in detail this connector, but below is a quick summary of the features:
...
The simplementation of the outbox is done using Quarkus Debezium outbox extension and explained in [this separate note](https://ibm-cloud-architecture.github.io/vaccine-solution-main/solution/orderms/).
...
Deploy and start the Debezium DB2 connector. The connector definition is [register-db2.json](https://github.com/ibm-cloud-architecture/vaccine-order-mgr/blob/master/environment/cdc/register-db2.json). What is important to consider in this configuration are:
