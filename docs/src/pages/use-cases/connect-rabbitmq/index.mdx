...
<strong>Updated 11/02/2020</strong>
</InlineNotification>
...
* Send some records using the simulator at the [http://localhost:8080/#/simulator](http://localhost:8080/#/simulator) URL and the user interface: 
...
* Create a project for RabbitMQ cluster. It is recommended to have separate project for RabbitMQ cluster.
Modify the namespace to be able to deploy RabbitMQ cluster into it. So we need to get user 999 authorized:
 ...
 Or use our custom  `oc apply -f rmq-cluster.yaml`
