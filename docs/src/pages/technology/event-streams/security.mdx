...
<AnchorLinks>
  ...
  <AnchorLink>Authentication with API Keys</AnchorLink>
  <AnchorLink>Control application access</AnchorLink>
</AnchorLinks>
...
When rotating the root key a new rewrapping of DEK is performed and the new key need to be communicated to Event Streams. 
</InlineNotification>