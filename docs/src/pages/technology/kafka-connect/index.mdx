...
We have developed different scenarios in [this lab](../event-streams/kconnect/) to remotely connect a Kafka Connect distributed cluster to Event Streams on cloud.
