...
<AnchorLinks> 
  <AnchorLink>What is Kafka?</AnchorLink>
  <AnchorLink>What are major use cases?</AnchorLink>
  <AnchorLink>Why does Kafka use zookeeper?</AnchorLink>
  <AnchorLink>What is a replica?</AnchorLink>
  <AnchorLink>What are a leader and follower in Kafka?</AnchorLink>
  <AnchorLink>What is Offset?</AnchorLink>
  <AnchorLink>What is a consumer group?</AnchorLink>
  <AnchorLink>How to support multi-tenancy?</AnchorLink>
  <AnchorLink>Retention time for topic what does it mean?</AnchorLink>
  <AnchorLink>How to support exactly once delivery?</AnchorLink>
  <AnchorLink>How to get at most once delivery?</AnchorLink>
  <AnchorLink>What are the topic characteristics I need to define during requirements?</AnchorLink>
  <AnchorLink>What are the impacts of having not enough resource for Kafka?</AnchorLink>
  <AnchorLink>What Security support in Kafka</AnchorLink>
  <AnchorLink>Security configuration</AnchorLink>
  <AnchorLink>Verify consumer connection</AnchorLink>
   <AnchorLink>How to protect data at rest?</AnchorLink>
...
<AnchorLinks>
  <AnchorLink>What is sticky assignor?</AnchorLink>
  <AnchorLink>What is transaction in Kafka?</AnchorLink>
  <AnchorLink>How to get an homogeneous distribution of message to partitions?</AnchorLink>
  <AnchorLink>What should we do for queue full exception or timeout exception on producer?</AnchorLink>
  <AnchorLink>What is the high watermark?</AnchorLink>
  <AnchorLink>How to send large messages?</AnchorLink>
  <AnchorLink>How to maximize throughput?</AnchorLink>
  <AnchorLink>Why Kafka Stream applications may impact cluster performance?</AnchorLink>
  <AnchorLink>How message schema version is propagated?</AnchorLink>
  <AnchorLink>Consumers do not see message in topic, what happens?</AnchorLink>
  <AnchorLink>How compression schema used is known by the consumer?</AnchorLink>
  <AnchorLink>What does out-of-synch partition mean and when it occurs?</AnchorLink>
  <AnchorLink>Run Kafka Test Container with TopologyTestDriver</AnchorLink>
  <AnchorLink>How to remove personal identifying information?</AnchorLink>
   <AnchorLink>How to handle variable workload with Kafka Connector source connector?</AnchorLink>
</AnchorLinks>

## Derived products related questions

<AnchorLinks>
  <AnchorLink>Competitors to Kafka</AnchorLink>
   <AnchorLink>Differences between AMQ Streams and Confluent</AnchorLink>
  <AnchorLink>Differences between Akka and Kafka?</AnchorLink>
   <AnchorLink>Event streams resource requirements </AnchorLink>
</AnchorLinks>
...
* Topic, consumer, producer, brokers, cluster [see this note for deeep dive](/kafka-overview/)
* Rich API to control the producer semantic, and consumer
* Consumer groups. [See this note for detail](/technology/kafka-producers-consumers/#consumer-group)
...
It groups consumers of one to many topics. Each partition is consumed by exactly one consumer within each subscribing [consumer group](/technology/kafka-producers-consumers/#consumer-group).
