...
|-------------|------------------------|------------------------|:-------:|:---:|
| 1  | Event Streams on Cloud  | Local Kafka | Local on localhost   | [Kafka Mirror Maker 2 - Lab 1](/scenarios/kafka-mm2/lab-1/)|
| Lab 2 | Using Mirror Maker 2 from Event Streams on premise to Event stream on cloud | On OCP | [Kafka Mirror Maker 2 - Lab 2](/scenarios/kafka-mm2/lab-2/) |
