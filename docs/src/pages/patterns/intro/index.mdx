...
The following figure illustrates an implementation using an event driven solution with data replication to synchronize back the write model to the read model being on the mainframe. 
