...
![Saga with MQ](./images/saga-ochestration-mq.png)

An alternate is to use Kafka with producer using full ackowledge, idempotence, and a bstch size of 1, and different topics
mostly configured as queue: one consumer in each consumer group

![Saga with topics](./images/saga-ochestration-kafka.png)
