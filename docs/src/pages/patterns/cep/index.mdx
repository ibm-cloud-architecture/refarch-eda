...
* Make more informed decisions by applying business rules and business logic
* Improve business responsiveness and minimize compliance risks

## The reference architecture

To make it simple, situational decision acts on event streams, so needs to be connected to event backbones. The 