...
- Next we'll send messages to an Event Streams topic from our Quarkus application which then triggers the IBM COS Connector to grab messages and place into an IBM COS Bucket.
- Finally our Sink connector will grab from the topic and place into a PostgreSQL database.

![Architecture Diagram](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Quarkus%20to%20Event%20Streams%20to%20COS.png)


## Scenario Prerequisites - 
- OpenShift Container Platform Cluster - This story will assume you have a 4.x Cluster as we will make use of Operators.
- Cloud Pak for Integration - This will assume you have probably at least a 2019.4.1 or 2020.x.x release of the Cloud Pak for Integration installed on OpenShift. This story will also assume you have followed the installation instructions for Event Streams outlined here from the [Cloud Pak Playbook](https://cloudpak8s.io/integration/cp4i-deploy-eventstreams/) and have a working Event Streams instance.
- Java Development Kit (JDK) v1.8+ (Java 8+)
- Gradle v4.0+ (Note - the gradle shadowJar command might not work on Java 13)
...
![Generate API Key 5](https://github.com/jackyng88/cloudpak-eventstreams-story/raw/master/supporting-pictures/Generate%20API%20Key%20-png)
...
![IBM COS Catalog Search](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20Cloud%20Create%20COS%20Service.png)

- Name your IBM COS Service with something unique. Since this is a free account we can stick with the Lite Plan.

![IBM COS Create COS Service](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20Cloud%20Create%20COS%20Service%202.png)
...
![IBM COS Custom Bucket](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20COS%20Create%20Bucket.png)
...
![IBM COS Custom Bucket Settings](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20COS%20Bucket%20Settings.png)
...
![IBM COS Service Credential](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20COS%20Create%20Service%20Cred.png)

- Name your credential and select `Manager` from the `Role:` drop-down menu and click `Add`.

![IBM COS SC Settings](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20COS%20Service%20Credential.png)

- Expand your newly created Service Credential and write down the values for `"apikey"` and `"resource_instance_id"`.

![Expanded Service Cred](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20Service%20Credential%20Keys.png)
...
![OperatorHub](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Operator%20Hub.png)

- Type "Strimzi" into the Search Bar.

![Strimzi](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Strimzi.png)

- Click on the Strimzi Operator and then click "Install".

![Operator Install](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Operator%20Install.png)

- Make sure that the option to have "All namespaces on the cluster (default)" is checked.

![Operator Subscription](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Operator%20Subscription.png)
...
![Operator Installing](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Strimzi%20Operator%20Installing.png)
...
![Operator Success](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Strimzi%20Operator%20Success.png)

![Operator Console](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Strimzi%20Operator%20Console.png)
...
![IBM COS Sink Connector success](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20COS%20Sink%20Connector%20success.png)
...
![Quarkus Run Success](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/Quarkus%20Run%20Success.png)
...
![End to End Success](https://github.ibm.com/Jacky-Ng/cloudpak-es-cloudagnostic/blob/master/supporting-pictures/IBM%20COS%20Bucket%20Success.png)

- The name of the file inside the bucket has starting offset and ending offset. You can download one of these object files and make sure that the value inside matches the value inside your `INBOUND` topic.
