...
As a pre-requisite you need to run your local cluster by using the docker compose as introduced in [this note](/scenarios/kafka-mm2/#pre-requisites).
...
1. Modify .env file to set environment variables for Source Event Streams cluster brokers address and APIKEY.
 ...
 The configuration file is for standalone configuration, and looks like:
