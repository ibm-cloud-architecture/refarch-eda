---
title: Near real-time Inventory, powered by AMQ Streams
...
<AnchorLinks>
  ...
  <AnchorLink>Lab 1: Demonstrate near real-time inventory with AMQ Streams</AnchorLink>
...
## Lab 1: Demonstrate near real-time inventory with AMQ Streams
...
1. Work from the cloned repository: `cd eda-lab-inventory`
