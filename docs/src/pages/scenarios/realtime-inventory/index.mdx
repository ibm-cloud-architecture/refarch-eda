...
<strong>Updated 06/22/2021</strong> - Work in progress
</InlineNotification>
...
<AnchorLinks>
  ...
  <AnchorLink>Lab 1: Demonstrate real-time inventory with AMQ Streams</AnchorLink>
...
combined with store application and servers, e-commerce suite, and a set of SOA services acting as backend systems.
...
1. Define the environment variables for your deployment in the: `scripts/env-AMQStreams.sh`. you mostly want to change the following variables or use our settings:
...
1. Start the deploy with one script `./scripts/deployInventorySolutionWithAMQStreams.sh --skip-login`. This should create AMQ streams cluster, and deploy the 4 applications.
  ...
  amq-kafka-zookeeper-0                        1/1     Running   0          4d
  amq-kafka-zookeeper-1                        1/1     Running   0          4d
  amq-kafka-zookeeper-2                        1/1     Running   0          4d
