...
Data lineage describes data origins, movements, characteristics, ownership and quality. 
...
Without duplicating the [specification](https://www.asyncapi.com/) is the specification to define schema and middleware binding. we want to highlight here what are the important part to consider in the data goverance:

* The Asynch API documentation
* The message schema
...
Schema registry can be deployed in different data center and serves multi Kafka clusters.
