...
* [Planning IBM Event Streams installation](https://ibm.github.io/event-streams/installing/planning/)
* [Develop Stream Application using Kafka](https://kafka.apache.org/25/documentation/streams/)
* [IBM Developer tutorial on access control, user authentication and authorization in Apache Kafka](https://developer.ibm.com/tutorials/kafka-authn-authz/)
